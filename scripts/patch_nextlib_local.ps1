# Patch nextlib media3ext AAR in third_party/maven - remove NextRenderersFactory to avoid R8 duplicate

Add-Type -AssemblyName System.IO.Compression.FileSystem

$AarPath = "E:\qclaw\Lelebox\Lelebox_src\third_party\maven\io\github\anilbeesetti\nextlib-media3ext\1.10.0-0.12.1\nextlib-media3ext-1.10.0-0.12.1.aar"
$TmpDir = "E:\qclaw\Lelebox\tmp\aar_patch2"
...
$removed = Get-ChildItem $jarDir -Recurse -Filter 'NextRenderersFactory*' -Force
...
Write-Host "Done! Patched AAR written to $AarPath"